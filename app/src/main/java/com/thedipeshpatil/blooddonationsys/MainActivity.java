...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    EditText name, email, phone, blood, id;
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( !TextUtils.isEmpty(d_blood) && !TextUtils.isEmpty(d_email) && !TextUtils.isEmpty(d_name) && !TextUtils.isEmpty(d_phone)){
                    ...
                    Toast.makeText(MainActivity.this, "Required Fields Cannot Be Blank", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                while(result.moveToNext()){
                    ...
                    stringBuffer.append("Email: " + result.getString(2) + "\n");
                    stringBuffer.append("Phone: " + result.getString(3) + "\n");
                    stringBuffer.append("Blood Group: " + result.getString(4) + "\n");
                    stringBuffer.append("\n");
                }
                showMessage("Blood Records", stringBuffer.toString());
            }
        });
